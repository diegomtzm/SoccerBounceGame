...
namespace SoccerBounce
{
    ...
    public class Game1 : Game
    {
        ...
        Texture2D imag;
        Texture2D vacia;
        Texture2D[] equipoRojo;
        Texture2D[] equipoAzul;
        Texture2D[] listaConos;
        Texture2D[] listaTachones;
        KeyboardState teclado;
        MouseState mouse, oldMouseState;
        SpriteFont letrero, titulo, botones, score, timer, relojEspera, marcadorFinal, marcadorFinal2;
        ...
        Color menuBackground = new Color(0, 0, 0, 180), buttonColor = new Color(Color.Red, 190), buttonG1Color, buttonG2Color, buttonG3Color, buttonExitColor;
        Texture2D menuRect, buttonG1, buttonG2, buttonG3, buttonExit, botonVacio;
        Texture2D jugador;
        ...
        protected override void LoadContent()
        {
            ...
            botonVacio = Content.Load<Texture2D>("botonVacio");
        ...
        void updPause()
        {
            ...
            if ((mouseObj.Intersects(boton1) || buttonG1Color == Color.CadetBlue) && (mouse.LeftButton == ButtonState.Pressed || teclado.IsKeyDown(Keys.Enter)))
            {
                buttonG1Color = Color.White;
                if (estadoJuegoAnt == 1)
                    estadoJuego = 1;
            ...
            if ((mouseObj.Intersects(boton2) || buttonG2Color == Color.CadetBlue) && (mouse.LeftButton == ButtonState.Pressed || teclado.IsKeyDown(Keys.Enter)))
            {
                buttonG2Color = Color.White;
                if (estadoJuegoAnt == 1)
                {
            ...
            if ((mouseObj.Intersects(boton3) || buttonG3Color == Color.CadetBlue) && (mouse.LeftButton == ButtonState.Pressed || teclado.IsKeyDown(Keys.Enter)))
            {
                buttonG3Color = Color.White;
                fms8 = 0;
                estadoJuegoAnt = estadoJuego;
        ...
        void drawSecondGame()
        {
            ...
            spriteBatch.DrawString(letrero, "Malos " + malos + "/6", new Vector2(685, 25), Color.White);
